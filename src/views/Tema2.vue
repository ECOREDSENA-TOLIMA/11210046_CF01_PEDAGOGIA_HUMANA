  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido(data-aos="flip-up")
      .titulo-principal__numero
        span 2
      h1 Estrategias pedagógicas
    p.mb-4(data-aos="fade-left") En el campo educativo, el concepto de estrategia ha evolucionado para adaptarse a las necesidades cambiantes de los entornos educativos modernos. Según Mialaret (1984), la estrategia se define como "la ciencia o arte de combinar y coordinar acciones con vistas a alcanzar una finalidad", involucrando una planificación cuidadosa con objetivos claros y medios adecuados para lograrlos.
    ...
    p.mb-4(data-aos="fade-left") Aguirre y colaboradores (2012) identifican diversas estrategias pedagógicas clave:
    ...
    .container.BGIMG02.px-4.px-md-5.pt-4
      .row.justify-content-center.mb-4
        .col-lg-10.col-12
          p Estas estrategias no solo se fundamentan en teorías educativas sólidas, sino que también dependen de la identificación de los estilos de aprendizaje individuales y de la capacidad creativa del educador para adaptar los recursos y el currículo a las necesidades específicas de los estudiantes.
          .row.justify-content-center.align-items-center
            .col-lg-6.col-12.mb-3
              figure
      ...
      .col-lg-10.col-12
        .bloque-texto-f.color-primario.pt-4.px-5.mb-0
          ...
          .bloque-texto-f__autor.mb-3.p-4
            h4.mb-4 Según Contreras y Bosque (2004)
            h5.text-regular.bloque-texto-f__texto Cada persona aprende de manera diferente a las demás, utilizando diversas estrategias, con ritmos y eficacias distintas, a pesar de tener el mismo nivel de instrucción, edad o estudiar el mismo tema.
        p(data-aos="fade-left") Este concepto se conoce como estilo cognitivo, que se refiere a la preferencia individual en la representación, procesamiento y recuperación de la información para facilitar el aprendizaje óptimo.

    p.mb-5(data-aos="fade-left") En la actualidad, las teorías sobre estilos de aprendizaje han evolucionado, incluyendo enfoques como la teoría de las inteligencias múltiples de Howard Gardner, que reconoce la diversidad de habilidades y capacidades cognitivas entre los estudiantes. Además, se ha destacado la importancia del aprendizaje situado y contextualizado, que considera el entorno y las experiencias del estudiante como factores determinantes en el proceso educativo.
    ...
    .bloque-texto-g.color-primario.p-3.p-sm-4.p-md-5.mb-5(data-aos="flip-up")
      .bloque-texto-g__img(
        :style="{'background-image': `url(${require('@/assets/curso/temas/tema2/12.png')})`}"
      )
      .bloque-texto-g__texto.p-4
        p.mb-0 El modelo VAK <i>(Visual, Auditory, Kinesthetic)</i> se asocia frecuentemente con Neil Fleming, un educador de Nueva Zelanda, quien lo popularizó en los años 1980. Fleming se basó en su experiencia en la enseñanza y observaciones sobre cómo los estudiantes aprenden mejor. No obstante, el concepto de los tres canales de aprendizaje (visual, auditivo y kinestésico) tiene sus raíces en el trabajo de Richard Bandler y John Grinder, los creadores de la Programación Neurolingüística (PNL), en la década de 1970. Bandler y Grinder identificaron estos canales como formas principales en las que las personas perciben y procesan la información. Fleming adaptó y amplió estos conceptos para aplicarlos específicamente en el ámbito educativo.
    p.mb-4(data-aos="fade-left") El modelo VAK se ha convertido en una herramienta popular para adaptar las estrategias de enseñanza a los diferentes estilos de aprendizaje de los estudiantes, mejorando así la efectividad de la enseñanza. Comprender estos canales puede ayudar a los educadores a diseñar estrategias pedagógicas más efectivas.
